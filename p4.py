...
def chatbot_response(user_input):
    ...
    responses = {
        ...
        r"\b(11|sugar)\b":"Sugar is 30rs per kg.",
        r"\b(12|vegetables|veggies)\b": "We have fresh vegetables available. What are you looking for?",
        r"\b(13|fruits)\b": "We have apples, bananas, and oranges in stock. Which one do you need?",
        r"\b(14|snacks)\b": "We have chips, biscuits, and chocolates available.",
        r"\b(15|beverages|drinks)\b": "We have soft drinks, juices, and bottled water. What would you like?",
        r"\b(16|buy|order)\b": "You can place an order on our website or visit our store.",
        r"\b(17|payment methods)\b": "We accept cash, credit/debit cards, and UPI payments.",
        r"\b(18|store hours|timing)\b": "Our store is open from 8 AM to 10 PM every day.",
        r"\b(19|location|address)\b": "We are located at XYZ Market, Main Street, City.",
        r"\b(20|bye|exit)\b": "Goodbye! Happy shopping! 🛍"
    }
